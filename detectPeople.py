...
#cv2.circle(copy_blueprint, CAMERA_LOCATION, 10, (0, 255, 0), -1)4
...
manageCamera.add_text_data('Test11.txt', 'Videos/TestVids/Cam1Test1.MP4', (180, 588), 340, 70.7, 27)
manageCamera.add_text_data('Test12.txt', 'Videos/TestVids/Cam2Test1.MP4', (57, 103), 104, 73.7, 24)
